...
<div class="space-y-8">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm font-medium text-secondary/40 mt-1">Kelola program kemitraan sekolah dan komunitas pendidik.</p>
        </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50">
                        <th class="px-8 py-5 text-[10px] font-black text-secondary/40 uppercase tracking-widest">Nama Layanan</th>
                    ...
                    <tr class="group hover:bg-gray-50/30 transition-all">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-14 rounded-2xl bg-gray-100 flex items-center justify-center text-primary font-black text-lg overflow-hidden border border-gray-100 flex-shrink-0">
                                    @if($item->image)
                        ...
                        <td class="px-8 py-6 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="{{ route('admin.bisnis.destroy', $item->slug) }}" method="POST" onsubmit="return confirm('Hapus layanan ini?')">
                                    @csrf @method('DELETE')
