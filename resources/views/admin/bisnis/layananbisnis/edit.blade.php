...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <form action="{{ route('admin.layanan-bisnis.update', $service->id) }}" method="POST" class="space-y-6">
        @csrf @method('PUT')
        <div class="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    <x-input-label for="image" value="URL Ikon / Gambar" />
                    <x-text-input id="image" name="image" type="text" :value="old('image', $service->image)" />
                </div>
