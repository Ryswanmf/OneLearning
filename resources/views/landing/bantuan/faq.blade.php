        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-32 p-12 bg-gray-50 rounded-[4rem] border border-gray-100 text-center relative overflow-hidden group">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="https://wa.me/6289515915699" class="px-10 py-4 bg-primary text-white font-black text-xs uppercase tracking-widest rounded-full hover:bg-secondary transition-all shadow-xl flex items-center gap-2">
