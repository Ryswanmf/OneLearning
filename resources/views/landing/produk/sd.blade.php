...
@section('title', 'Tryout SD 4-6 - Persiapan Ujian Sekolah Terbaik | OneLearning')
    ...
    <section id="daftar-tryout" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-secondary/50 font-medium mt-4">Pilih mata pelajaran yang ingin kamu latih hari ini.</p>
            </div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-center justify-between mt-8">
                            ...
                            @auth
                                ...
                                @endphp
                                @if($hasAccess)
                                    <a href="{{ route('tryout.instructions', ['type' => 'sd', 'id' => $tryout->slug]) }}" class="px-6 py-3 bg-secondary text-white font-black text-xs uppercase tracking-widest rounded-xl hover:bg-primary transition-all">Kerjakan</a>
                                @else
                                    <a href="{{ route('order.checkout', ['type' => 'sd', 'id' => $tryout->slug]) }}" class="px-6 py-3 bg-primary text-white font-black text-xs uppercase tracking-widest rounded-xl hover:bg-secondary transition-all">Beli Paket</a>
                                @endif
                            @else
